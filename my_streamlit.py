...
df_filtered2 = df[(df.AnneePerte == year) & (df.TypeObjet == obj_type)]
...
df_filtered2['NbObjets'] = df_filtered.apply(lambda row: getattr(row, 'Freq_' + year) * 0.01, axis=1)
...
for index, row in df_filtered.iterrows():
    popup_text = "Gare : " + row['Nom'] + "<br>" + "Nombre d'objets trouvés : " + str(row['NbObjetsTrouves']+"<br>"+"Frequentation : " + row("Freq_"+year))
